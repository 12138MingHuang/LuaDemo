...
namespace XLua
{
    public partial class DelegateBridge : DelegateBridgeBase
    {
		...
		public void __Gen_Delegate_Imp0(out string p0, ref int p1)
		{
            ...
            lock (luaEnv.luaEnvLock)
            {
                ...
                p0 = LuaAPI.lua_tostring(L, errFunc + 1);
		...
		public void __Gen_Delegate_Imp1(LuaCore p0)
		{
#if THREAD_SAFE || HOTFIX_ENABLE
            lock (luaEnv.luaEnvLock)
            {
		...
		public override Delegate GetDelegateByType(Type type)
		{
		    ...
		    if (type == typeof(Func4))
			{
			    return new Func4(__Gen_Delegate_Imp0);
			}
		
		    if (type == typeof(TransMy))
			{
